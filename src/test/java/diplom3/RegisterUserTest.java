...
public class RegisterUserTest {
    ...
    public void correctRegisterUserUpPersonalAccount() {
        ...
        pageLoginPersonalAccount.isTextPageFormLoginDisplayed();
        ...
        assertTrue("Переход на страницу Входа, не произошел, пользователь не зарегистрирован", pageLoginPersonalAccount.isTextPageFormLoginDisplayed());
}
    @Test
    ...
    public void invalidRegisterUserUpPersonalAccountErrorPassword() {
        ...
        assertFalse("Сообщение, что пароль некорректный не сработало, выполнен переход на экранную форму Входа", pageLoginPersonalAccount.isTextPageFormLoginDisplayed());
    }
}
